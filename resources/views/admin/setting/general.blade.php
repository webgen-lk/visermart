                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="required"> @lang('Preloader Title')</label>
                                    <input class="form-control" type="text" name="preloader_title" required value="{{ gs('preloader_title') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-6">
                                <label class="required"> @lang('Record to Display Per page')</label>
